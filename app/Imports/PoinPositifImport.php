...
class PoinPositifImport implements ToModel, WithHeadingRow, WithValidation
{
    /**
    ...
    /**
     * Memasukkan data ke model atau melakukan update jika data dengan id_poin_positif sudah ada
     */
    public function model(array $row)
    {
        ...
        $existingData = DataPoinPositif::find($row['id_poin_positif']);
        if ($existingData) {
            $existingData->update([
    ...
    public function rules(): array
    {
        return [
            ...
            'attributes' => [
                'Id Poin Positif' => 'Id Poin Positif',
                'Nama Poin'       => 'Nama Poin',
                'Poin'            => 'Poin',
    ...
    {
        return [
            'id_poin_positif'   => 'Id Poin Positif',
            'nama_poin'         => 'Nama Poin',
            'poin'              => 'Poin',
