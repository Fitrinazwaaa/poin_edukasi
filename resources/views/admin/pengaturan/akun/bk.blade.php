...
<head>
    ...
    <style>
        ...
        #admin-settings-container .header {
            text-align: center;
            margin-bottom: 20px;
        }

        #admin-settings-container .profile-icon {
            width: 80px;
            height: 80px;
            border-radius: 50%;
        ...
        #admin-settings-container .profile-text strong {
            font-size: 22px;
            display: block;
            margin-top: 10px;
        }

        #admin-settings-container .profile-text p {
            color: #555;
            font-size: 14px;
        }

        #admin-settings-container hr {
            border: 0;
            height: 1px;
        ...
        #admin-settings-container button.btn {
            width: 100%;
            padding: 12px;
            background-color: #1e90ff;
            border: none;
        ...
        #admin-settings-container button.btn:hover {
            background-color: #1c86ee;
        }

        #admin-settings-container .alert {
        ...
        #admin-settings-container .secure-info {
        ...
        #admin-settings-container .secure-info a {
            color: #1e90ff;
            text-decoration: none;
        }

        #admin-settings-container .secure-info a:hover {
        ...
        <div class="container">
            <div class="header">
                ...
                <div class="profile-text">
                    <strong id="profile-username">{{ $datauser->firstWhere('role', 'admin')->username ?? 'Bimbingan Konseling' }}</strong>
