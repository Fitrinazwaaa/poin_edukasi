...
<head>
    ...
    <style>
        ...
        #user2-settings-container .container {
        ...
        #user2-settings-container .header {
            text-align: center;
            margin-bottom: 20px;
        }

        #user2-settings-container .profile-icon {
            width: 80px;
            height: 80px;
            border-radius: 50%;
        ...
        #user2-settings-container .profile-text strong {
            font-size: 22px;
            display: block;
            margin-top: 10px;
        }

        #user2-settings-container .profile-text p {
            color: #555;
            font-size: 14px;
        }

        #user2-settings-container hr {
            border: 0;
            height: 1px;
        ...
        #user2-settings-container h3 {
            font-size: 18px;
            margin-bottom: 10px;
        }

        #user2-settings-container label {
            display: block;
            font-size: 14px;
            margin-bottom: 5px;
        }

        #user2-settings-container input {
            width: 100%;
            padding: 10px;
        ...
        #user2-settings-container button.btn {
            width: 100%;
            padding: 12px;
            background-color: #1e90ff;
            border: none;
        ...
        #user2-settings-container button.btn:hover {
            background-color: #1c86ee;
        }

        #user2-settings-container .alert {
        ...
        #user2-settings-container .secure-info {
        ...
        #user2-settings-container .secure-info a {
            color: #1e90ff;
            text-decoration: none;
        }

        #user2-settings-container .secure-info a:hover {
...
<body>
    <div id="user2-settings-container">
        <div class="container">
            <div class="header">
