...
<body class="body">
    ...
    @section('content')
    <p class="text-center">FORMULIR PERBAIKAN</p>
    <div class="container">
        <form action="{{ route('StoreNamaPoinSiswa' , $data['nis']) }}" method="POST">
            ...
            <div class="form-row">
                ...
                <input type="text" name="tingkatan" value="{{ $data['tingkatan'] }}" class="form-control" style="margin-right: 20px;" readonly>
                <input type="text" name="jurusan" value="{{ $data['jurusan'] }}" class="form-control" style="margin-right: 20px;" readonly>
