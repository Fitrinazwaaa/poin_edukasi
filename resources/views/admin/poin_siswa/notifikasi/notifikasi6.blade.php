...
<body>
    ...
    @if($poinPeringatan6 && $poinPeringatan7)
        <h5 class="text-center">{{ $poinPeringatan6->peringatan }}</h5>
        <p class="text-center">Poin Negatif {{ $poinPeringatan6->max_poin }} - {{ $poinPeringatan7->max_poin }} </p>
    @endif
